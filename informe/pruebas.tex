...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{img/carga_reglas_logs.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/resultado_pingall.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{img/resultado_pingall_switches.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/resultado_curl_h4-h1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/resultado_iperf_h4-h1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{img/resultado_wireshark_bloqueo_h4-h1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/resultado_curl_8000_h4-h1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{img/resultado_wireshark_no_bloqueo_h4-h1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/resultado_iperf_udp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{img/resultado_wireshark_bloqueo_h1_udp_5001.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{img/resultado_wireshark_no_bloqueo_h2_udp_5001.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/pings_h2_h3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/resultados_iperfs_h2-h3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/ping_h2-h1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/ping_h3-h4.png}
